        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkAt = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndustriesCompanies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IndustriesCompanies_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IndustriesCompanies_Industries_IndustryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndustriesCompanies_CompanyId",
                table: "IndustriesCompanies",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_IndustriesCompanies_IndustryId",
                table: "IndustriesCompanies",
                column: "IndustryId");
